...
export const api = {
  ...
  updateLLMSettings: (data: any) => req("POST", "/settings/llm", data),
  testLLM: (data: any) => req("POST", "/settings/llm/test", data),
  getSchema: () => req("GET", "/settings/schema"),
  updateSchema: (schemas: any) => req("POST", "/settings/schema", { schemas }),
